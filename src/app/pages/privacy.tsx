        ...
        <div className="flex gap-10">
          ...
          <div className="flex-1 space-y-8 text-sm text-muted-foreground leading-relaxed pb-16">
              ...
              <div className="pl-6 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-2">
                    ...
                    <li>Authentication sessions stored in secure HttpOnly cookies</li>
            ...
            <section id="cookies" className="scroll-mt-6 space-y-3">
              ...
              <div className="pl-6 space-y-2">
                <p>
                  We use secure HttpOnly cookies for authentication. SessionStorage may briefly hold a one-time PKCE verifier during OAuth, but never an access or refresh token. LocalStorage is used only for non-sensitive preferences.
                  See our full{" "}
