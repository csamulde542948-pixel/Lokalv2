...
export function PostActionBar({
  ...
  const actionClassName = isModal
    ? "flex-1 flex items-center justify-center gap-2 py-2.5 transition-colors text-muted-foreground hover:text-foreground font-semibold text-[13px]"
    : "flex-1 flex items-center justify-center gap-2 py-2 transition-colors text-muted-foreground hover:text-foreground font-medium text-[13px] rounded-none";
  const reactionClassName = isModal
    ? `flex-1 flex items-center justify-center gap-2 py-2.5 cursor-pointer select-none transition-colors font-semibold text-[13px] ${reactionColorClassName}`
    : `flex-1 flex items-center justify-center gap-2 py-2 cursor-pointer select-none rounded-none transition-colors font-medium text-[13px] ${reactionColorClassName}`;
